...
function AudioControllerSoundJs(total_page, last_page, speech_speed, break_interval, vocab_controller_obj) {
	/*
		...
		if(paused_flag){
			...
			if(isFirefox){
				...
				if (sound_data != null) {
					...
					// });
					sound_data.on('complete', function() {
						soundplaycomplete = true;
						// sound_data.unbind('ended');
						// sound_data.on('complete');
						ternimatesound_play_animate($this, $span_speec_text);
